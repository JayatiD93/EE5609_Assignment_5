...
\implies (\vec{B-C})(\vec{B}+\vec{C}-2\vec{P})^T - 2(\vec{A-P})^T)=0\\
\implies (\vec{B-C})(\vec{B}+\vec{C}-2\vec{P})-(\vec{2A-2P}))^T=0\\
\implies (\vec{B-C})(\vec{B+C-2A})^T=0\\
\implies (\vec{B+C-2A})(\vec{B-C})^T=0\\
\end{multline}
...
\implies (\vec{B-C})(\vec{B}+\vec{C}-2\vec{P})^T - 2(\vec{D-P})^T)=0\\
\implies (\vec{B-C})(\vec{B}+\vec{C}-2\vec{P})-(\vec{2D-2P}))^T=0\\
\implies (\vec{B-C})(\vec{B+C-2D})^T=0\\
\implies (\vec{B+C-2D})(\vec{B-C})^T=0\\
\end{multline}
